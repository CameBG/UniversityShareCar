...
@section('content')
    ...
    <div style= "margin-left:33%">
        <form method="POST" action = "{{ action('AdministradorController@conductor_modificado', ['correo'=>$conductor->correo]) }}" enctype="multipart/form-data">
            @csrf
            <table>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <input style="float:left" type="text" name="localidad" id="localidad" value="{{ $localidad }}"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label style="float:left" for="universidad" >Universidad: &nbsp&nbsp</label>
                        <input style="float:left" type="text" name="universidad" id="universidad" value="{{ $universidad }}"/>
                    </td>
                </tr>
                <tr>
                    <td>
