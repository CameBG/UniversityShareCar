...
class CocheTest extends TestCase
{
    ...
    public function testQuery()
    {
        ...
        Coche::create(['Matricula' => 'A1234BC', 'Marca' => 'Mercedes', 'Modelo' => 'modelo1',     'Plazas' => 4, 'Precio' => 1, 'Conductor_Correo' => 'emailej1A@dss.es']);
        Coche::create(['Matricula' => 'X5678YZ', 'Marca' => 'Hyundai',  'Modelo' => 'modeloX',     'Plazas' => 4, 'Precio' => 1, 'Conductor_Correo' => 'emailej1A@dss.es']);
        Coche::create(['Matricula' => 'RT5555A', 'Marca' => 'Mercedes', 'Modelo' => 'modeloPeque', 'Plazas' => 2, 'Precio' => 1.5, 'Conductor_Correo' => 'emailej1B@dss.es']);
    ...
    public function testCrear() {
        ...
        $c_valid = new Coche(['Matricula' => 'ON4328A', 'Marca' => 'Dacia', 'Modelo' => 'modeloG', 'Plazas' => 3,  'Precio' => 1, 'Conductor_Correo' => 'emailej1D@dss.es']);
        $c_valid->save();
    ...
    public function testDuplicatePK(){
        ...
        $c_invalid = new Coche(['Matricula' => 'ON4328A', 'Marca' => 'Mercedes', 'Modelo' => 'modelo5', 'Plazas' => 2,  'Precio' => 1, 'Conductor_Correo' => 'emailej1D@dss.es']);
        $c_invalid->save();
    }
